...
export const obtenerUsuariosTarea = (id,setData,store) => {
  const { usuario, cargarUsuario, mostrarNotificacion, mostrarLoader } = store;


let url = ENTRYPOINT+"task_users/"+id
let setting = {
  method: "Get",
  url: url,
...
export const obtenerTodosAuth = (setData,store) => {
  const { usuario, cargarUsuario, mostrarNotificacion, mostrarLoader } = store;


let url = ENTRYPOINT+"tareas_auth"
let setting = {
  method: "Get",
  url: url,
  headers: { 'Accept': 'application/json',
