...
export const obtenerTodos = (setData) => {
  ...
  let url = ENTRYPOINT+"promotion/get_all"
  let setting = {
    method: "Get",
    url: url,
...
export const editar = (data, atras,store) => {
    ...
    let url = ENTRYPOINT+"promotion/edit";
    let setting = {
      method: "POST",
      url: url,
      data: data,
   ...
   export const registrar = (data,atras, store) => {
    ...
    let url = ENTRYPOINT+"promotion/register";
    let setting = {
      method: "POST",
      url: url,
      data: data,
  ...
  export const eliminar = (city_id,store,cargarData) => {
    ...
    let url = ENTRYPOINT+"promotion/delete";
    var raw = {
      promotion_id:city_id,
    };
    let setting = {
      method: "DELETE",
      url: url,
